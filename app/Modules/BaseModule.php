...
abstract class BaseModule implements ModuleInterface
{
    ...
    public function enable(): void
    {
        ...
        if (method_exists($this, 'onEnable')) {
            try {
                ...
                Log::error($msg, ['module' => $this->getName()]);
        ...
        try {
            ...
            Log::debug("Failed to dispatch ModuleEnabled event: ".$e->getMessage());
        }
    ...
    public function disable(): void
    {
        ...
        try {
            ...
            Log::debug("Failed to dispatch ModuleDisabled event: ".$e->getMessage());
        }
    ...
    public function install(): void
    {
        ...
        try {
            ...
            Log::debug("Failed to dispatch ModuleInstalled event: ".$e->getMessage());
        }
    ...
    public function uninstall(): void
    {
        ...
        try {
            ...
            Log::debug("Failed to dispatch ModuleUninstalled event: ".$e->getMessage());
        }
