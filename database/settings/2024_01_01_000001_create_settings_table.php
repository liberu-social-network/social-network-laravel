...
return new class extends SettingsMigration
{
    ...
    {
        $this->migrator->add('general.site_name', config('app.name', 'Liberu Social Network'));
        ...
        $this->migrator->add('general.github_url', 'https://github.com/liberu-social-network/social-network-laravel');
        $this->migrator->add('general.youtube_url', null);
        $this->migrator->add('general.footer_copyright', '© ' . date('Y') . ' ' . config('app.name', 'Liberu Social Network') . '. All rights reserved.');
    }
};